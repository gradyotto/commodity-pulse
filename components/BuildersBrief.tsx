    ...
    <section>
      ...
      {(status === "loading" || status === "done") && content && (
        <div className="bg-surface-raised border border-surface-border rounded-lg p-6">
          ...
          <div className="flex items-start justify-between mb-5 pb-4 border-b border-surface-border">
            <div>
              <div className="text-brand font-mono font-bold text-lg tracking-tight">
                BUILDER&apos;S BRIEF
              </div>
            ...
            <div className="text-right text-xs text-slate-600 font-mono">
              ...
              <div className="text-slate-700 mt-0.5">Powered by Claude Opus 4.6</div>
            </div>
          </div>
      ...
      {status === "done" && (
        <p className="text-xs text-slate-600 mt-2 font-mono">
          {fromCache
            ? "⚡ Served from cache (refreshes every 24h) · "
